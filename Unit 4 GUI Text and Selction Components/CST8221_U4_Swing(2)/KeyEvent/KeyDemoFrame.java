...
public class KeyDemoFrame extends JFrame implements KeyListener 
{
   ...
   private static final long serialVersionUID = 4924676179709679847L;
   ...
   private JTextArea textArea; // TextAarea to display output
   ...
   public KeyDemoFrame()
   {
      ...
      textArea.setEnabled( false ); // disable TextArea - do not respond to user input
      textArea.setDisabledTextColor( Color.RED ); // set text color
   ...
   {
      line1 = String.format( "Key pressed: %s at location %d" , 
        KeyEvent.getKeyText(event.getKeyCode()), event.getKeyLocation()); // show pressed key
